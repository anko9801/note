...
\begin{proof}
  \begin{align}
    B(z, \zeta) & = \int_{0}^{1}t^{z-1}(1-t)^{\zeta-1}\dd{t}                                                                             \\
                & = \int_{1}^{0}(1 - s)^{z-1}s^{\zeta-1}(-\dd{t}) \qquad (s = 1 - t)                                                     \\
                & = \int_{0}^{1}s^{\zeta-1}(1 - s)^{z-1}\dd{t}                                                                           \\
                & = B(\zeta, z)                                                                                                          \\
    B(z, \zeta) & = \int_{0}^{1}t^{z-1}(1-t)^{\zeta-1}\dd{t}                                                                             \\
                & = \int_{0}^{\pi/2}\sin^{2(z-1)}\theta\cos^{2(\zeta-1)}\theta2\sin\theta\cos\theta\dd{\theta} \qquad (t = \sin^2\theta) \\
                & = 2\int_0^{\pi/2}\sin^{2z - 1}\theta\cos^{2\zeta - 1}\theta\dd{\theta}                                                 \\
    B(z, \zeta) & = \int_{0}^{1}t^{z-1}(1-t)^{\zeta-1}\dd{t}                                                                             \\
  \end{align}
\end{proof}
...
\begin{proof}
  \begin{align}
    B(a, b)     & = \int_{0}^{1}t^{a-1}(1-t)^{b-1}\dd{t}                                                \\
                & = \qty[\frac{1}{a}t^a(1-t)^{b-1}]_0^1 + \frac{b-1}{a}\int_{0}^{1}t^a(1-t)^{b-2}\dd{t} \\
                & = \frac{b - 1}{a}B(a + 1, b - 1)                                                      \\
    B(a, n + 1) & = \frac{n\cdot(n - 1)\cdots 1}{a\cdot(a + 1)\cdots(a + n - 1)}B(a + n, 1)             \\
                & = \frac{n!}{\prod_{k = 0}^{n-1}(a + k)}\frac{1}{a + n}                                \\
...
\begin{proof}
  \begin{align}
    \Gamma(z)\Gamma(\zeta) & = \int_0^\infty s^{z-1}e^{-s}\dd{s}\int_0^\infty t^{\zeta-1}e^{-t}\dd{t}                                                                                          \\
                           & = \int_0^\infty q^{2(z-1)}e^{-q^2}2q\dd{q}\int_0^\infty p^{2(\zeta-1)}e^{-p^2}2p\dd{p}                                       & (s = q^2, t = p^2)                 \\
                           & = 4\int_0^\infty \int_0^\infty e^{-(q^2 + p^2)}q^{2z-1}p^{2\zeta-1}\dd{p}\dd{q}                                                                                   \\
                           & = 4\int_0^{\frac{\pi}{2}}\int_0^\infty e^{-r^2}r^{2(z + \zeta - 1)}\cos^{2z-1}\theta\sin^{2\zeta-1}\theta r\dd{r}\dd{\theta} & (q = r\cos\theta, p = r\sin\theta) \\
                           & = 4\int_0^\infty e^{-r^2}r^{2(z + \zeta) - 1}\dd{r}\int_0^{\frac{\pi}{2}}\cos^{2z-1}\theta\sin^{2\zeta-1}\theta\dd{\theta}                                        \\
                           & = 2\int_0^\infty e^{-R}R^{z + \zeta - 1}r\frac{1}{2r}\dd{R}B(z, \zeta)                                                       & (R = r^2)                          \\
                           & = \int_0^\infty e^{-R}R^{z + \zeta - 1}\dd{R}B(z, \zeta)                                                                                                          \\
                           & = \Gamma(z + \zeta)B(z, \zeta)
  \end{align}
  これより
  \begin{align}
    B(z, \zeta) & = \frac{\Gamma(z)\Gamma(\zeta)}{\Gamma(z + \zeta)}
